...
class CIEnvironmentConfig:
    ...
    def get_handler_config(self, handler_name: str) -> CacheHandlerConfig | None:
    ...
    def generate_env_file(self, handler_name: str, output_file: str | None = None) -> str:
        ...
        env_lines.append("# Generated by CI Environment Config Helper")
        env_lines.append("")
    ...
    def generate_docker_compose_services(self) -> dict[str, Any]:
        ...
        services["postgres"] = {
            "image": "postgres:16",
            "environment": {"POSTGRES_DB": "test_db", "POSTGRES_USER": "test_user", "POSTGRES_PASSWORD": "test_password"},
            "ports": ["5432:5432"],
            "healthcheck": {"test": ["CMD-SHELL", "pg_isready -U test_user -d test_db"], "interval": "10s", "timeout": "5s", "retries": 10},
        }
