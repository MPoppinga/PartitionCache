...
class TestQueueInterface:
    ...
    def test_push_to_original_query_queue_success(self, mock_get_handler):
        ...
        mock_handler.push_to_original_query_queue.assert_called_once_with("SELECT * FROM table", "test_partition_key")
    ...
    def test_push_to_original_query_queue_default_partition_key(self, mock_get_handler):
        ...
        assert result is True
        mock_handler.push_to_original_query_queue.assert_called_once_with("SELECT * FROM table", "partition_key")
    ...
    def test_pop_from_original_query_queue_success(self, mock_get_handler):
        ...
        mock_handler = Mock()
        mock_handler.pop_from_original_query_queue.return_value = ("SELECT * FROM table", "test_partition_key")
        mock_get_handler.return_value = mock_handler

        result = pop_from_original_query_queue()
        assert result == ("SELECT * FROM table", "test_partition_key")
...
class TestQueryFragmentQueue:
    ...
    def test_push_to_query_fragment_queue_success(self, mock_get_handler):
        ...
        assert result is True
        mock_handler.push_to_query_fragment_queue.assert_called_once_with(query_hash_pairs, "test_partition_key")
    ...
    def test_push_to_query_fragment_queue_default_partition_key(self, mock_get_handler):
        ...
        assert result is True
        mock_handler.push_to_query_fragment_queue.assert_called_once_with(query_hash_pairs, "partition_key")
    ...
    def test_push_to_query_fragment_queue_empty_list(self, mock_get_handler):
        ...
        assert result is True
        mock_handler.push_to_query_fragment_queue.assert_called_once_with([], "test_partition_key")

    @patch("partitioncache.queue._get_queue_handler")
    def test_pop_from_query_fragment_queue_success(self, mock_get_handler):
        """Test successful pop from query fragment queue."""
        mock_handler = Mock()
        mock_handler.pop_from_query_fragment_queue.return_value = ("SELECT * FROM table", "test_hash", "test_partition_key")
        mock_get_handler.return_value = mock_handler

        result = pop_from_query_fragment_queue()
        assert result == ("SELECT * FROM table", "test_hash", "test_partition_key")
...
class TestLegacyFunctions:
    ...
    def test_push_to_queue_calls_original_query_queue(self, mock_push_original):
        ...
        assert result is True
        mock_push_original.assert_called_once_with("SELECT * FROM table", "test_partition_key")
    ...
    def test_push_to_queue_default_partition_key(self, mock_push_original):
        ...
        assert result is True
        mock_push_original.assert_called_once_with("SELECT * FROM table", "partition_key")
...
class TestIntegration:
    ...
    def test_queue_roundtrip_original_query_queue(self, mock_get_handler):
        ...
        mock_handler = Mock()
        mock_handler.push_to_original_query_queue.return_value = True
        mock_handler.pop_from_original_query_queue.return_value = ("SELECT * FROM test_table", "test_partition_key")
        mock_get_handler.return_value = mock_handler
        ...
        assert pop_result == (test_query, test_partition_key)
    ...
    def test_queue_roundtrip_query_fragment_queue(self, mock_get_handler):
        ...
        mock_handler = Mock()
        mock_handler.push_to_query_fragment_queue.return_value = True
        mock_handler.pop_from_query_fragment_queue.return_value = ("SELECT * FROM test", "test_hash", "test_partition_key")
        mock_get_handler.return_value = mock_handler
        ...
        assert pop_result == ("SELECT * FROM test", "test_hash", test_partition_key)
