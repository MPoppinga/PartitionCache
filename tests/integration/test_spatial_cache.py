...
from partitioncache.cache_handler.helper import PartitionCacheHelper
...
class TestSpatialCache:
    ...
    def test_region_based_nearby_businesses(self):
        ...
        print(f"Region-based query results:")
    ...
    def test_region_based_business_clusters(self):
        ...
        print(f"Business cluster query results:")
        print(f"  Results: {result['results_count']}")
    ...
    def test_city_based_partitioning(self):
        ...
        print(f"City-based query results:")
        print(f"  Results: {result['results_count']}")
        print(f"  Cache effectiveness: {result['cache_effective']}")
    ...
    def test_city_based_nearest_neighbors(self):
        ...
        print(f"Nearest neighbor query results:")
        print(f"  Results: {result['results_count']}")
    ...
    def test_zipcode_based_partitioning(self):
        ...
        print(f"Zipcode-based query results:")
        print(f"  Results: {result['results_count']}")
        print(f"  Cache effectiveness: {result['cache_effective']}")
    ...
    def test_cross_zipcode_distances(self):
        ...
        print(f"Cross-zipcode query results:")
        print(f"  Results: {result['results_count']}")
        print(f"  This tests cross-partition optimization")
    ...
    def test_points_near_businesses(self):
        ...
        print(f"Points near businesses query results:")
        print(f"  Results: {result['results_count']}")
        print(f"  Tests cross-table spatial optimization")
