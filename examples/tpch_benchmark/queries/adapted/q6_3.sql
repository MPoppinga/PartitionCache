-- TPC-H Q6.3 adapted: part hierarchy - Brand#13 + ECONOMY BURNISHED BRASS
...
WHERE l.l_orderkey IN (SELECT o_orderkey FROM orders WHERE o_orderdate >= '1994-01-01' AND o_orderdate < '1997-01-01')
  AND l.l_partkey IN (SELECT p_partkey FROM part WHERE p_brand = 'Brand#13' AND p_type = 'ECONOMY BURNISHED BRASS')
